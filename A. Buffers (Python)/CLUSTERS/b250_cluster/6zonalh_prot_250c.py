...
# b250_cluster_b*, found in the clean data folder, under DEFORESTATION/CLUSTERS/250_cluster.
# --------------------------------------------------------------------------------------------
...
for b in buffers:
    # Fix geometries
    input_vector = f"{cd}DATA_CLEAN/CREDIT/GLEBAS/CLUSTERS/b250_cluster/b250_cluster_{b}/b250_cluster_{b}_ring_prot.shp"
    fixed_vector = f"{cd}DATA_CLEAN/CREDIT/GLEBAS/CLUSTERS/b250_cluster/b250_cluster_{b}/b250_cluster_{b}_ring_prot_fixed.shp"
    ...
    for y in years:
        ...
        output_csv = f"{cd}DATA_CLEAN/DEFORESTATION/CLUSTERS/b250_cluster/b250_cluster_{b}/b250_cluster_{b}_cover{y}_prot.csv"
...
# Fix geometries
input_vector = f"{cd}DATA_CLEAN/CREDIT/GLEBAS/CLUSTERS/b250_cluster/b250_cluster_b0/b250_cluster_b0_prot.shp"
fixed_vector = f"{cd}DATA_CLEAN/CREDIT/GLEBAS/CLUSTERS/b250_cluster/b250_cluster_b0/b250_cluster_b0_prot_fixed.shp"
...
for y in years:
    input_raster = f"{cd}DATA_RAW/DEFORESTATION/Mapbiomas/{y}_cover.tif"
    output_csv = f"{cd}DATA_CLEAN/DEFORESTATION/CLUSTERS/b250_cluster/b250_cluster_b0/b250_cluster_b0_cover{y}_prot.csv"
