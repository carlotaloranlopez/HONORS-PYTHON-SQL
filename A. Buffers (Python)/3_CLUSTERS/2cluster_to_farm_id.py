...
b0_f= os.path.join(cd, "b0/b0_fixed.shp")
cd = "/zfs/students/cloranlo/Downloads/CREDIT_DEFOREST/DATA/DATA_CLEAN/CREDIT/GLEBAS/CLUSTERS/"
cluster250= os.path.join(cd, "b250_cluster/b250_cluster_b0/b500_cluster_b0.shp")
cluster250_fixed= os.path.join(cd, "b250_cluster/b500_cluster_b0/b250_cluster_b0_fixed.shp")
cluster500= os.path.join(cd, "b500_cluster/b500_cluster_b0/b500_cluster_b0.shp")
cluster500_fixed= os.path.join(cd, "b500_cluster/b500_cluster_b0/b500_cluster_b0_fixed.shp")
cluster1000= os.path.join(cd, "b1000_cluster/b1000_cluster_b0/b1000_cluster_b0.shp")
cluster1000_fixed= os.path.join(cd, "b1000_cluster/b1000_cluster_b0/b1000_cluster_b0_fixed.shp")
cluster2000= os.path.join(cd, "b2000_cluster/b2000_cluster_b0/b2000_cluster_b0.shp")
cluster2000_fixed= os.path.join(cd, "b2000_cluster/b2000_cluster_b0/b2000_cluster_b0_fixed.shp")
...
for f in [b0_f, cluster250_fixed, cluster500_fixed, cluster1000_fixed, cluster2000_fixed, cluster250_to_farm_id, cluster500_to_farm_id, cluster1000_to_farm_id, cluster2000_to_farm_id]:
    delete_shapefile(f)
...
processing.run("native:fixgeometries", {
    'INPUT': cluster250,
    'METHOD': 1,
    'OUTPUT': cluster250_fixed
    }
)
processing.run("native:fixgeometries", {
    'INPUT': cluster500,
    'METHOD': 1,
    'OUTPUT': cluster500_fixed
    }
)
processing.run("native:fixgeometries", {
    'INPUT': cluster1000,
    'METHOD': 1,
    'OUTPUT': cluster1000_fixed
    }
)
processing.run("native:fixgeometries", {
    'INPUT': cluster2000,
    'METHOD': 1,
    'OUTPUT': cluster2000_fixed
    }
)
processing.run("native:fixgeometries", {
    'INPUT': b0,
...
cluster_250_src = QgsProcessingFeatureSourceDefinition(
    cluster250_fixed,
    flags=QgsProcessingFeatureSourceDefinition.FlagOverrideDefaultGeometryCheck,
    geometryCheck=QgsFeatureRequest.GeometrySkipInvalid
)
cluster_500_src = QgsProcessingFeatureSourceDefinition(
    cluster500_fixed,
    flags=QgsProcessingFeatureSourceDefinition.FlagOverrideDefaultGeometryCheck,
    geometryCheck=QgsFeatureRequest.GeometrySkipInvalid
)
cluster_1000_src = QgsProcessingFeatureSourceDefinition(
    cluster1000_fixed,
    flags=QgsProcessingFeatureSourceDefinition.FlagOverrideDefaultGeometryCheck,
    geometryCheck=QgsFeatureRequest.GeometrySkipInvalid
)
cluster_2000_src = QgsProcessingFeatureSourceDefinition(
    cluster2000_fixed,
    flags=QgsProcessingFeatureSourceDefinition.FlagOverrideDefaultGeometryCheck,
    geometryCheck=QgsFeatureRequest.GeometrySkipInvalid
)
...
processing.run("native:joinattributesbylocation", {
    ...
    'PREFIX':'c',
    'OUTPUT':cluster250_to_farm_id
})
processing.run("native:joinattributesbylocation", {
    'INPUT': cluster_500_src,
    'PREDICATE':[1,2,4],
    'JOIN': b0_src,
    'JOIN_FIELDS':['fid'],
    'METHOD':0,
    'DISCARD_NONMATCHING':False,
    'PREFIX':'c',
    'OUTPUT':cluster500_to_farm_id
})
processing.run("native:joinattributesbylocation", {
    'INPUT': cluster_1000_src,
    'PREDICATE':[1,2,4],
    'JOIN': b0_src,
    'JOIN_FIELDS':['fid'],
    'METHOD':0,
    'DISCARD_NONMATCHING':False,
    'PREFIX':'c',
    'OUTPUT':cluster1000_to_farm_id
})
processing.run("native:joinattributesbylocation", {
    'INPUT': cluster_2000_src,
    'PREDICATE':[1,2,4],
    'JOIN': b0_src,
    'JOIN_FIELDS':['fid'],
    'METHOD':0,
