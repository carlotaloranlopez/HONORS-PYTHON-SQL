...
# b500_cluster_b*, found in the clean data folder, under DEFORESTATION/CLUSTERS/500_cluster.
# --------------------------------------------------------------------------------------------
...
for y in years:
    input_raster = f"{cd}DATA_RAW/DEFORESTATION/Mapbiomas/{y}_cover.tif"
    output_csv = f"{cd}DATA_CLEAN/DEFORESTATION/CLUSTERS/b500_cluster/b500_cluster_b0/b500_cluster_b0_cover{y}_prot.csv"
