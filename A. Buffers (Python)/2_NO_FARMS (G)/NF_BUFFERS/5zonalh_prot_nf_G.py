...
# b*, found in the clean data folder, under DEFORESTATION/NO_FARMS/NF_BUFFERS.
# --------------------------------------------------------------------------------------------
...
for b in buffers:
    # Fix geometries
    input_vector = f"{cd}DATA_CLEAN/CREDIT/GLEBAS/NO_FARMS/NF_BUFFERS/b{b}/b{b}_ring_prot.shp"
    fixed_vector = f"{cd}DATA_CLEAN/CREDIT/GLEBAS/NO_FARMS/NF_BUFFERS/b{b}/b{b}_ring_prot_fixed.shp"
    ...
    for y in years:
        ...
        output_csv = f"{cd}DATA_CLEAN/DEFORESTATION/NO_FARMS/NF_BUFFERS/b{b}/b{b}_cover{y}_prot.csv"
...
# Fix geometries
input_vector = f"{cd}DATA_CLEAN/CREDIT/GLEBAS/NO_FARMS/NF_BUFFERS/b0/b0_prot.shp"
fixed_vector = f"{cd}DATA_CLEAN/CREDIT/GLEBAS/NO_FARMS/NF_BUFFERS/b0/b0_prot_fixed.shp"
...
for y in years:
    input_raster = f"{cd}DATA_RAW/DEFORESTATION/Mapbiomas/{y}_cover.tif"
    output_csv = f"{cd}DATA_CLEAN/DEFORESTATION/NO_FARMS/NF_BUFFERS/b0/b0_cover{y}_prot.csv"
